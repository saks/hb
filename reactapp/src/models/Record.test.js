...
const data = [
    ...
    },
    {
        ...
        user: 'http://localhost:8000/api/user/1/',
        tags: ['SCHOOL'],
        amount: { amount: 123.0, currency: { code: 'CAD', name: 'Canadian Dollar' } },
        transaction_type: 'EXP',
    ...
    },
    {
        ...
        user: 'http://localhost:8000/api/user/1/',
        tags: ['FUN'],
        amount: { amount: 245.0, currency: { code: 'CAD', name: 'Canadian Dollar' } },
    ...
    },
    {
        ...
        user: 'http://localhost:8000/api/user/1/',
        tags: ['ZZZ'],
        amount: { amount: 125.0, currency: { code: 'CAD', name: 'Canadian Dollar' } },
        transaction_type: 'EXP',
    ...
    },
    {
        ...
        user: 'http://localhost:8000/api/user/1/',
        tags: ['BAR'],
        amount: { amount: 124.0, currency: { code: 'CAD', name: 'Canadian Dollar' } },
        transaction_type: 'EXP',
    ...
    },
    {
        ...
        user: 'http://localhost:8000/api/user/1/',
        tags: ['foo'],
        amount: { amount: 12.0, currency: { code: 'CAD', name: 'Canadian Dollar' } },
        transaction_type: 'EXP',
    ...
    },
    {
        ...
        user: 'http://localhost:8000/api/user/1/',
        tags: ['SCHOOL'],
        amount: { amount: 345345.0, currency: { code: 'CAD', name: 'Canadian Dollar' } },
        transaction_type: 'EXP',
