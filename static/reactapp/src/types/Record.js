...
export type SetCurrentPageAction = { type: 'SET_CURRENT_PAGE_FOR_RECORDS_PAGE', pageNum: number };
export type SetListAction = { type: 'SET_LIST_FOR_RECORDS_PAGE', list: Array<Attrs> };
