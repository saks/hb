    ...
    return (
        <div>
            <header className="navbar navbar-expand navbar-dark bg-info mb-3 py-0">
              <a className="navbar-brand mr-auto text-white" href="/static/app/index.html">Octo Budget</a>
              <ul className="nav justify-content-end nav-tabs">
                <li className="nav-item">
                  <a className="nav-link text-white" data-target="NewRecordForm" >
                    <svg height="24" className="octicon octicon-plus" viewBox="0 0 12 16" version="1.1" width="24" aria-hidden="true">
                ...
                <li className="nav-item">
                  <a className="nav-link text-white" data-target="IndexPage" >
                    <svg height="24" className="octicon octicon-list-unordered" viewBox="0 0 12 16" version="1.1" width="24" aria-hidden="true">
                ...
                <li className="nav-item">
                  <a className="nav-link text-white" data-target="BudgetsPage" >
                    <svg height="24" className="octicon octicon-graph" viewBox="0 0 16 16" version="1.1" width="24" aria-hidden="true"><path fillRule="evenodd" d="M16 14v1H0V0h1v14h15zM5 13H3V8h2v5zm4 0H7V3h2v10zm4 0h-2V6h2v7z"></path></svg>
                  </a>
                </li>
              </ul>
            </header>
