...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('budgets', '0002_auto_20181204_1826'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='CAD', max_digits=15)),
                ('comment', models.TextField(blank=True, null=True)),
                ('tags_type', models.CharField(choices=[('INCL', 'Tags Include'), ('EXCL', 'Tags Exclude')], max_length=4)),
                ('tags', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(max_length=20), blank=True, default=list, size=None)),
                ('name', models.CharField(default='Year budget', max_length=100, verbose_name='Budget name')),
                ('year', models.IntegerField(choices=[(2015, 2015), (2016, 2016), (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020)], default=budgets.models.current_year, verbose_name='year')),
